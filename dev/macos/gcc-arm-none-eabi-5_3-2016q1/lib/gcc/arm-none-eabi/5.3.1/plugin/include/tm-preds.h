/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/Users/build/workspace/GCC-5-0-build_build-toolchain-mac/gcc-arm-none-eabi-5_3-2016q1-20160330/src/gcc/gcc/config/arm/arm.md'.  */
